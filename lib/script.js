    ...
    function models(tipo) {
      ...
      if (tipo == "arbol") {
         data = BalancedTree(document.getElementById('nodeCount1').value, document.getElementById('alturaArbol').value);
         options = {
  "edges": {
    "smooth": {
      "forceDirection": "none"
  ...
  "physics": {
    ...
    "minVelocity": 0.75
         ...
         data = BarabasiAlbert(document.getElementById('nodeCount1').value, document.getElementById('m0').value, document.getElementById('M').value); 
      }
      else if (tipo == "erdosRenyiP") {

         data = erdosRenyiP(document.getElementById('nodeCount2').value, document.getElementById('ERP').value); 
      }
      else if (tipo == "erdosRenyiM") {

         data = erdosRenyiM(document.getElementById('nodeCount3').value, document.getElementById('ERE').value); 
      }
      else if (tipo == "wattsStrogatzA") {

         data = wattsStrogatzA(document.getElementById('nodeCount4').value, document.getElementById('wattsStrogatzAlphaK').value, document.getElementById('wattsStrogatzAlpha').value); 
      }
      else if (tipo == "wattsStrogatzB") {

         data = wattsStrogatzB(document.getElementById('nodeCount5').value, document.getElementById('wattsStrogatzBetaK').value, document.getElementById('wattsStrogatzBeta').value); 
      }
    ...
    function wattsStrogatzB (n, K, beta) {
        ...
        for (i = graph.nodes.length; i < num; i++) {
            for (j = 1; j <= K; j++) { 
                if (Math.random() <= beta) {
                    do {
                        t = Math.floor(Math.random() * (num-1));
